...
6b) Run the chunks from the beginning only through ComputeSingles (click on line 440 to move the cursor there and then choose Run->Run All Chunks Above)
7b) Please share the "[site]_singleminingresults.rda" file in the output directory.

Output table of only summary statistics on single items:
